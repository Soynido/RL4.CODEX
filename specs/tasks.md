...
| TASK-008 | P0 | Mettre à jour `spec.md` vers RL4-CODEX v1.2 avec terminologie normative, règles d’ordre canonique, hashing, taille et compatibilité. | `specs/plan.md` Phase 2, user brief 2025-11-26 | PENDING |
